...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    is_coco = opt.data.endswith('ab.yaml') and nc == 80  # COCO dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='F:/yolov5-develop/weights/yolov5s.pt',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str, default='F:/yolov5-develop/models/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='F:/yolov5-develop/data/ab.yaml', help='dataset.yaml path')
